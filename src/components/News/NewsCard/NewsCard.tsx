...
const NewsCard = () => {
  return (
    <div className="flex items-center justify-between w-full rounded border-[1px] border-secondary border-opacity-40 h-[8rem] overflow-hidden cursor-pointer bg-primary bg-opacity-90 hover:opacity-90 transition-all">
